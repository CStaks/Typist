...
import { posToDOMRect, findParent, findNodeInSelection, nodeRule, browser } from '@milkdown/kit/prose';
...
const LatexTooltip = defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      return /* @__PURE__ */ h("div", { class: "container" }, props.innerView.value && /* @__PURE__ */ h("div", { ref: innerViewRef }), /* @__PURE__ */ h("button", { type: "button", onPointerdown: onUpdate }, /* @__PURE__ */ h(Icon, { icon: props.config.inlineEditConfirm })));
    };
  }
});
