...
function useAIProviderConfig(ctx) {
  return ctx.get("aiProviderConfig");
}
...
function useAIInstructionTooltipAPI(ctx) {
  return ctx.get(
    "aiInstructionTooltipAPI"
  );
}
...
exports.ai = ai;
exports.defaultAIIcon = aiIcon;
exports.defaultBuildContext = defaultBuildContext;
exports.runAICmd = runAICmd;
exports.useAIInstructionTooltipAPI = useAIInstructionTooltipAPI;
exports.useAIProviderConfig = useAIProviderConfig;
