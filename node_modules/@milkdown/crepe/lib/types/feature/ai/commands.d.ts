...
export declare const aiProviderConfig: import("@milkdown/utils").$Ctx<AIProviderConfigValue, "aiProviderConfig">;
export declare function useAIProviderConfig(ctx: Ctx): AIProviderConfigValue;
