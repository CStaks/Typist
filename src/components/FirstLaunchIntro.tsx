    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <div className="mb-5 flex items-center gap-3"><img src="/assets/typist.png" alt="" className="h-12 w-12 rounded-2xl object-contain shadow-sm" /><p className="text-sm font-medium text-[var(--accent)]">Welcome to Typist</p></div>
